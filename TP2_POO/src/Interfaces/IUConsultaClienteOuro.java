 ...
 * @author Martines
 */
public class IUConsultaClienteOuro extends javax.swing.JDialog {
     ...
     */
    public IUConsultaClienteOuro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object [][] linha = control.relatorioClientesOuro();
        for(int cont = 0; cont < control.retornaQuantidadeClientesOuro(); cont++){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IUConsultaClienteOuro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IUConsultaClienteOuro dialog = new IUConsultaClienteOuro(new javax.swing.JFrame(), true);
