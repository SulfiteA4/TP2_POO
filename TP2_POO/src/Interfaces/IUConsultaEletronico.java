 ...
 * @author Martines
 */
public class IUConsultaEletronico extends javax.swing.JDialog {
     ...
     */
    public IUConsultaEletronico(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object [][] linha = control.relatorioEletronicos();
        for(int cont = 0; cont < control.retornaQuantidadeEletronicos(); cont++){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IUConsultaEletronico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IUConsultaEletronico dialog = new IUConsultaEletronico(new javax.swing.JFrame(), true);
