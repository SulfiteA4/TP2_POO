 ...
 * @author Martines
 */
public class IUConsultaEletrodomesticos extends javax.swing.JDialog {
     ...
     */
    public IUConsultaEletrodomesticos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object [][] linha = control.relatorioEletrodomesticos();
        for(int cont = 0; cont < control.retornaQuantidadeEletrodomesticos(); cont++){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IUConsultaEletrodomesticos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IUConsultaEletrodomesticos dialog = new IUConsultaEletrodomesticos(new javax.swing.JFrame(), true);
